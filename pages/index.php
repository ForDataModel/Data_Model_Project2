<?php
    ...
    $sql2 ="SELECT Staff.Name, Staff.Gender, Staff.Personal_ID,Staff.Birthday,Parttime.Hourpay,Station.Name
            FROM Staff 
            INNER JOIN Parttime 
            ...
            <div class="row">
                ...
                <div id="msg" class="col-xs-4 col-xs-offset-2">
                    ...
                    <div class="col-xs-12">
                        ...
                        <input class="col-xs-7" type="text" placeholder="yyyy-mm-dd" name="Birthday">
                    </div>
                    <div class="col-xs-12">
