...
(11, '林顯宗', 1, 'jdijbfb', '1996-04-10', '2018-12-08 14:59:15', 0);
...
INSERT INTO `Product` (`Product_ID`, `Product_name`, `Price`, `Product_amount`, `Cost`, `Station_ID`) VALUES
(1, '去漬油', 35, 74, 31.5, 1),
(2, '環保二行程機油-0.7L', 120, 25, 80.41, 1),
(3, '二行程機油-0.7L', 91, 40, 61, 1),
(4, '二行程機油-1L', 0, 0, 0, 1),
(5, '特優機油SAE30#-1L', 113, 13, 75.75, 1),
(6, '特優機油SAE40#-1L', 113, 12, 75.75, 1),
(7, '特優機油15/40-1L', 120, 18, 80.41, 1),
(8, 'DOT-3高級煞車油', 0, 0, 0, 1),
(9, '自動變速器油', 0, 0, 0, 1),
(10, '特優機油SAE40#4L', 420, 3, 281.5, 1),
(11, '特優機油15/40-4L', 455, 3, 304.83, 1),
(12, '超重機油CF30#-4L', 415, 2, 278, 1),
(13, '超重機油CF40#-4L', 430, 2, 288, 1),
(14, '超優CH4車用-4L', 0, 0, 0, 1),
(15, '多效齒輪油80/90-4L', 0, 0, 0, 1),
(16, 'R32循環油-4L', 385, 5, 276.5, 1),
(17, 'R68循環油-4L', 385, 3, 283.5, 1),
(18, '煤油-4L', 239, 6, 223, 1),
(19, 'R32循環油-18L', 1550, 2, 1120, 1),
(20, 'R68循環油-19L', 1720, 2, 1243, 1),
(21, '環保去漬油19公升(5加侖)', 1150, 0, 1000, 1),
(22, '煤油20公升', 1024, 0, 940, 1),
(23, '超重CF40-19公升(5加侖)', 1810, 1, 1213, 1),
(24, '汽車油精', 200, 23, 95, 1),
(25, '機車油精', 59, 46, 35, 1),
(26, '柴油油精', 200, 19, 95, 1),
(27, '操作機油CF10W200L', 0, 0, 0, 1),
(28, '特優機油20W/50-1L', 0, 0, 0, 1),
(29, '超優CI4車用機油-4L', 0, 0, 0, 1),
(30, '滑道68循環油-19公升(5加侖)', 1960, 1, 1568, 1),
(31, '超重機油CF30-19公升(5加侖)', 1810, 1, 1213, 1),
(32, '2號多效脂', 0, 0, 0, 1),
(33, '汽油清淨劑', 250, 2, 200, 1),
(34, '9000SJ車用機油-5W/50-1L', 400, 1, 268, 1),
(35, '9000SL車用機油-10W/40-1L', 400, 0, 300, 1),
(36, 'DOT-4高級煞車油', 0, 0, 0, 1),
(37, '多效齒輪油85W/140-4L', 0, 0, 0, 1),
(38, '去漬油19公升(5加侖)', 700, 0, 650, 1),
(39, 'R68-200公升', 11310, 0, 10000, 1),
(40, '車用多效滑脂15kg', 2295, 0, 1836, 1),
(41, '特級3號杯脂', 2275, 0, 1820, 1),
(42, '蘋果傳輸線', 590, 3, 210, 1),
(43, '安卓傳輸線', 290, 0, 126, 1),
(44, '胎壓器', 5990, 1, 3780, 1),
(45, '50元洗車券', 50, 0, 0, 1),
(46, '80元洗車券', 80, 1975, 0, 1),
(47, '100元洗車券', 100, 465, 0, 1);
...
(34, 'tinaluo', 0, 'A527384950', '1996-09-03', 1),
...
--
ALTER TABLE `Oil`
  MODIFY `Oil_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
